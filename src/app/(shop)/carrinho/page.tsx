...
export default function CartPage() {
    ...
    const shippingCost = 0; // Placeholder until calculation is implemented
                ...
                <div className="w-full lg:w-96 shrink-0 space-y-6">
                    ...
                    <div className="bg-slate-50 p-6 rounded-xl border border-slate-100 shadow-sm space-y-4">
                        ...
                        <Link href="/checkout" className="block w-full">
                            <Button className="w-full h-12 text-base font-bold shadow-md hover:shadow-lg transition-all" size="lg">
                                Finalizar Compra
                            </Button>
                        </Link>
