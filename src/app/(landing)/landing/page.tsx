        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              {/* Floating cards */}
              <div className="absolute -left-8 top-1/4 bg-white rounded-xl shadow-xl p-4 animate-float hidden lg:block">
              ...
              <div className="absolute -right-4 bottom-1/4 bg-white rounded-xl shadow-xl p-4 animate-float-delayed hidden lg:block">
                <div className="flex items-center gap-3">
