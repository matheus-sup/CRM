...
// =============================================================================
// TESTIMONIALS BLOCK - Reviews e Depoimentos
// =============================================================================
            ...
            <div className="w-full py-16 text-center">
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    <h3 className="text-2xl font-bold mb-2" style={{ color: styles.textColor }}>
                        {content.title || "O que estão falando da gente"}
                    </h3>
                    <p className="text-muted-foreground mb-4">
                        {content.subtitle || "Reviews e depoimentos de clientes"}
                    </p>
                    <p className="text-sm text-muted-foreground">
                        Adicione depoimentos nas configurações deste bloco
                    </p>
                </div>
            </div>
        );
            ...
            <div className="max-w-6xl mx-auto px-4">
                ...
                {(content.title || content.subtitle) && (
                    <div className="text-center mb-10">
                        ...
                        {content.subtitle && (
                            <p className="text-muted-foreground" data-field="subtitle">
                                {content.subtitle}
                            </p>
                        )}
                    </div>
                ...
                return (
                    ...
                    >
                        ...
                        <div className={cn(
                            ...
                            {block.type === "testimonials" && <TestimonialsBlock content={block.content} styles={styles} />}
