...
CREATE TABLE "new_StoreConfig" (
    ...
    "headerLogoWidth" INTEGER NOT NULL DEFAULT 120,
    "headerText" TEXT,
    "headerSubtext" TEXT,
    "headerSearchPlaceholder" TEXT NOT NULL DEFAULT 'O que você está buscando?',
...
INSERT INTO "new_StoreConfig" ("accentColor", "address", "backgroundColor", "bannerUrl", "bodyColor", "bodyFont", "bodyFontSize", "cartAction", "cartCountBg", "cartCountText", "categoryDefaultImage", "cnpj", "createdAt", "description", "desktopColumns", "email", "enableQuickBuy", "enableQuickCart", "facebook", "facebookPixelId", "fontFamily", "footerBg", "footerLogo", "footerText", "googleTagId", "headerBtnBg", "headerBtnText", "headerColor", "headingColor", "headingFont", "headingFontSize", "homeLayout", "id", "instagram", "instagramToken", "legalName", "logoUrl", "maintenanceMessage", "maintenanceMode", "maintenancePassword", "mapUrl", "menuColor", "menuFont", "menuFontSize", "minPurchaseValue", "mobileColumns", "newsletterEnabled", "paginationType", "phone", "pinterest", "pinterestTag", "priceColor", "productBtnBg", "productBtnText", "searchBtnBg", "searchIconColor", "secondaryColor", "sectionTitleColor", "showBuyInfo", "showCardCarousel", "showCartRecommendations", "showColorVariations", "showDiscountPayment", "showHoverImage", "showInstallments", "showInstallmentsDetail", "showLowStockWarning", "showMeasurements", "showPaymentMethods", "showProductSold", "showPromoPrice", "showRelatedProducts", "showSKU", "showShippingCalculator", "showShippingSimulator", "showSocialIcons", "showStockQuantity", "showVariations", "storeName", "textColor", "themeColor", "tiktok", "twitter", "updatedAt", "whatsapp", "youtube") SELECT "accentColor", "address", "backgroundColor", "bannerUrl", "bodyColor", "bodyFont", "bodyFontSize", "cartAction", "cartCountBg", "cartCountText", "categoryDefaultImage", "cnpj", "createdAt", "description", "desktopColumns", "email", "enableQuickBuy", "enableQuickCart", "facebook", "facebookPixelId", "fontFamily", "footerBg", "footerLogo", "footerText", "googleTagId", "headerBtnBg", "headerBtnText", "headerColor", "headingColor", "headingFont", "headingFontSize", "homeLayout", "id", "instagram", "instagramToken", "legalName", "logoUrl", "maintenanceMessage", "maintenanceMode", "maintenancePassword", "mapUrl", "menuColor", "menuFont", "menuFontSize", "minPurchaseValue", "mobileColumns", "newsletterEnabled", "paginationType", "phone", "pinterest", "pinterestTag", "priceColor", "productBtnBg", "productBtnText", "searchBtnBg", "searchIconColor", "secondaryColor", "sectionTitleColor", "showBuyInfo", "showCardCarousel", "showCartRecommendations", "showColorVariations", "showDiscountPayment", "showHoverImage", "showInstallments", "showInstallmentsDetail", "showLowStockWarning", "showMeasurements", "showPaymentMethods", "showProductSold", "showPromoPrice", "showRelatedProducts", "showSKU", "showShippingCalculator", "showShippingSimulator", "showSocialIcons", "showStockQuantity", "showVariations", "storeName", "textColor", "themeColor", "tiktok", "twitter", "updatedAt", "whatsapp", "youtube" FROM "StoreConfig";
